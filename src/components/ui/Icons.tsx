...
// Academic Cap Icon
export function AcademicCapIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
// Eye Slash Icon
export function EyeSlashIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
...
export function ExclamationTriangleIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg
      className={className}
      width={size}
