...
#### 主要メンバー・役割
| 役割 | 名前 / GitHub | 連絡先 | 担当領域 |
|------|--------------|-------|----------|
| 責任者 | 黒澤 (@yusuke-kurosawa) | kurosawa@sas-com.com | 全体統括・意思決定 |
| PM | 中島 (@SAS-nakajima) | nakajima@sas-com.com | プロジェクト管理・進捗統制 |
| PL | 笹尾 (@SAS-sasao) | sasao@sas-com.com | 技術統括・開発リード |
| 開発メンバー | 柏崎 (@MichihiroKashiwazaki) | - | フロントエンド開発 |
| 開発メンバー | 室山 (@muroyama) | - | バックエンド開発 |
| 開発メンバー | 杉本 (@sas-sugimoto) | - | AI機能開発 |
| 開発メンバー | 市川 (@sas-ichikawa) | - | UI/UX設計 |
| 開発メンバー | 金子晄士 (@Akito-Kaneko) | - | テスト・品質管理 |
