...
|-----------------|--------------------------|---------------------------|------------------------------------------------|--------------------|--------|-----------------|
| [SCR-TENANT-ADMIN](specs/画面設計書_SCR-TENANT-ADMIN.md) | テナント管理画面         | マルチテナント管理        | テナント作成・編集・削除、設定管理              | ホールディングス管理者 | 最高   | [詳細設計書](specs/画面設計書_SCR-TENANT-ADMIN.md) |
| [SCR-TENANT-SELECT](specs/画面設計書_SCR-TENANT-SELECT.md) | テナント選択画面         | マルチテナント認証        | テナント選択、マルチテナント認証                | 全ユーザー         | 最高   | [詳細設計書](specs/画面設計書_SCR-TENANT-SELECT.md) |
| [SCR-NOTIFY-ADMIN](specs/画面設計書_SCR-NOTIFY-ADMIN.md) | 通知設定管理画面         | 通知・連携管理            | テナント別通知設定、通知テンプレート管理        | テナント管理者     | 高     | [詳細設計書](specs/画面設計書_SCR-NOTIFY-ADMIN.md) |
