...
#### 191. ⚠️ 外部キー ['setting_id'] -> MST_NotificationSettings.['id'] がDDLにのみ存在します
...
#### 192. ⚠️ 外部キー ['integration_config_id'] -> SYS_IntegrationConfig.['id'] がDDLにのみ存在します
...
#### 194. ⚠️ 外部キー ['setting_id'] -> MST_NotificationSettings.['id'] がYAMLにのみ存在します
...
#### 195. ⚠️ 外部キー ['integration_config_id'] -> SYS_IntegrationConfig.['id'] がYAMLにのみ存在します
...
#### 200. ⚠️ 外部キー ['target_department_id'] -> MST_Department.['id'] がDDLにのみ存在します
...
#### 201. ⚠️ 外部キー ['target_position_id'] -> MST_Position.['id'] がDDLにのみ存在します
...
#### 205. ⚠️ 外部キー ['supervisor_id'] -> MST_Employee.['id'] がDDLにのみ存在します
...
#### 206. ⚠️ 外部キー ['target_department_id'] -> MST_Department.['id'] がYAMLにのみ存在します
...
#### 207. ⚠️ 外部キー ['target_position_id'] -> MST_Position.['id'] がYAMLにのみ存在します
...
#### 211. ⚠️ 外部キー ['supervisor_id'] -> MST_Employee.['id'] がYAMLにのみ存在します
...
#### 212. ⚠️ 外部キー fk_career_plan_target_department のON DELETE設定が不一致
...
#### 221. ⚠️ 外部キー ['target_department_id'] -> MST_Department.['id'] がDDLにのみ存在します
...
#### 227. ⚠️ 外部キー ['target_department_id'] -> MST_Department.['id'] がYAMLにのみ存在します
...
#### 236. ⚠️ 外部キー fk_cert_req_target_job_type のON DELETE設定が不一致
...
#### 306. ⚠️ 外部キー ['assigned_by'] -> MST_UserAuth.['user_id'] がDDLにのみ存在します
...
#### 307. ⚠️ 外部キー ['user_id'] -> MST_UserAuth.['user_id'] がDDLにのみ存在します
...
#### 310. ⚠️ 外部キー ['assigned_by'] -> MST_UserAuth.['user_id'] がYAMLにのみ存在します
...
#### 311. ⚠️ 外部キー ['user_id'] -> MST_UserAuth.['user_id'] がYAMLにのみ存在します
...
#### 326. ⚠️ 外部キー ['approved_by'] -> MST_Employee.['id'] がDDLにのみ存在します
...
#### 329. ⚠️ 外部キー ['approved_by'] -> MST_Employee.['id'] がYAMLにのみ存在します
...
#### 333. ⚠️ 外部キー fk_TRN_GoalProgress_career_plan のON DELETE設定が不一致
...
#### 340. ⚠️ 外部キー ['related_project_id'] -> TRN_ProjectRecord.['project_record_id'] がDDLにのみ存在します
...
#### 346. ⚠️ 外部キー fk_pdu_approver のON DELETE設定が不一致
