...
#### 200. ⚠️ 外部キー ['supervisor_id'] -> MST_Employee.['id'] がDDLにのみ存在します
...
#### 202. ⚠️ 外部キー ['target_position_id'] -> MST_Position.['id'] がDDLにのみ存在します
...
#### 206. ⚠️ 外部キー ['supervisor_id'] -> MST_Employee.['id'] がYAMLにのみ存在します
...
#### 208. ⚠️ 外部キー ['target_position_id'] -> MST_Position.['id'] がYAMLにのみ存在します
...
#### 213. ⚠️ 外部キー fk_career_plan_target_position のON DELETE設定が不一致
...
#### 222. ⚠️ 外部キー ['target_position_id'] -> MST_Position.['id'] がDDLにのみ存在します
...
#### 228. ⚠️ 外部キー ['target_position_id'] -> MST_Position.['id'] がYAMLにのみ存在します
...
#### 234. ⚠️ 外部キー fk_cert_req_target_position のON DELETE設定が不一致
...
#### 236. ⚠️ 外部キー fk_cert_req_target_department のON DELETE設定が不一致
...
#### 256. ⚠️ 外部キー ['created_by'] -> MST_Employee.['id'] がDDLにのみ存在します
...
#### 261. ⚠️ 外部キー ['created_by'] -> MST_Employee.['id'] がYAMLにのみ存在します
...
#### 350. ⚠️ 外部キー ['related_project_id'] -> TRN_ProjectRecord.['project_record_id'] がDDLにのみ存在します
...
#### 353. ⚠️ 外部キー ['related_certification_id'] -> MST_Certification.['id'] がDDLにのみ存在します
...
#### 355. ⚠️ 外部キー ['related_project_id'] -> TRN_ProjectRecord.['project_record_id'] がYAMLにのみ存在します
...
#### 358. ⚠️ 外部キー ['related_certification_id'] -> MST_Certification.['id'] がYAMLにのみ存在します
...
#### 361. ⚠️ 外部キー fk_evidence_verifier のON DELETE設定が不一致
...
#### 368. ⚠️ 外部キー fk_skill_category のON DELETE設定が不一致
...
#### 369. ⚠️ 外部キー fk_skill_certification のON DELETE設定が不一致
...
#### 2. ⚠️ カラム 'technology_trend' のNULL制約が一致しません
...
#### 3. ⚠️ カラム 'technology_trend' のデフォルト値が一致しません
...
#### 5. ⚠️ カラム 'skill_type' のNULL制約が一致しません
...
#### 6. ⚠️ カラム 'skill_type' のデフォルト値が一致しません
...
#### 7. ⚠️ カラム 'skill_name' のNULL制約が一致しません
...
#### 10. ⚠️ カラム 'is_active' のNULL制約が一致しません
...
#### 11. ⚠️ カラム 'is_active' のデフォルト値が一致しません
...
#### 12. ⚠️ カラム 'display_order' のNULL制約が一致しません
...
#### 13. ⚠️ カラム 'display_order' のデフォルト値が一致しません
...
#### 14. ⚠️ カラム 'difficulty_level' のNULL制約が一致しません
...
#### 15. ⚠️ カラム 'difficulty_level' のデフォルト値が一致しません
...
#### 16. ⚠️ カラム 'created_at' のNULL制約が一致しません
...
#### 17. ⚠️ カラム 'created_at' のデフォルト値が一致しません
...
#### 18. ⚠️ カラム 'tenant_id' のNULL制約が一致しません
...
#### 19. ⚠️ カラム 'updated_at' のNULL制約が一致しません
...
#### 20. ⚠️ カラム 'updated_at' のデフォルト値が一致しません
...
#### 21. ⚠️ カラム 'category_id' のNULL制約が一致しません
...
#### 22. ⚠️ カラム 'is_deleted' のNULL制約が一致しません
...
#### 23. ⚠️ カラム 'is_deleted' のデフォルト値が一致しません
...
#### 24. ⚠️ カラム 'market_demand' のNULL制約が一致しません
...
#### 25. ⚠️ カラム 'market_demand' のデフォルト値が一致しません
...
#### 26. ✅ カラム 'effective_from' のデータ型整合性OK
...
#### 27. ✅ カラム 'skill_name_en' のデータ型整合性OK
...
#### 28. ✅ カラム 'evaluation_criteria' のデータ型整合性OK
...
#### 29. ✅ カラム 'effective_to' のデータ型整合性OK
...
#### 30. ✅ カラム 'required_experience_months' のデータ型整合性OK
...
#### 31. ✅ カラム 'prerequisite_skills' のデータ型整合性OK
...
#### 32. ✅ カラム 'learning_resources' のデータ型整合性OK
...
#### 34. ✅ カラム 'certification_info' のデータ型整合性OK
...
#### 35. ✅ カラム 'related_skills' のデータ型整合性OK
