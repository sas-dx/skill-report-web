...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="テーブル定義書生成スクリプト v9.0",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
使用例:
  # 全テーブル生成
  python3 create_table_definitions_final.py
  
  # 個別テーブル生成
  python3 create_table_definitions_final.py --table MST_Employee
  python3 create_table_definitions_final.py --table MST_Role,MST_Permission
  
  # 出力先指定
  python3 create_table_definitions_final.py --table MST_Employee --output-dir custom/
        """
    )
