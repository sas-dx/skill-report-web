...
プロジェクトに参加する全ての開発者が対象で、Windows・macOS・Linux環境に対応しています。
...
# PATHに追加（.zshrcまたは.bash_profileに追加）
...
### macOS
- Homebrewのインストールを推奨
- Xcode Command Line Toolsが必要な場合がある
- M1/M2 Macの場合、Rosetta 2が必要な場合がある
